...
:deep(.c-green) { color: #00ff41; }
:deep(.c-dim) { color: #00ff4160; }
:deep(.c-bright) { color: #fff; }
:deep(.c-blue) { color: #4fc3f7; }
:deep(.c-yellow) { color: #ffd54f; }
:deep(.c-red) { color: #ff5252; }
:deep(.c-cyan) { color: #00bcd4; }
